...
const FavoritesManager = lazy(() => import('./events/FavoritesManager'));
...
const FinancesAccountsTransactions = lazy(
  () => import('./finances/Accounts/Transactions/Transactions')
);
const FinancesCategorize = lazy(
  () => import('./finances/Accounts/Categorize/Categorize')
);
...
const FinancesPayments = lazy(
  () => import('./finances/Credit/Payments/Payments')
);
const FinancesTimetables = lazy(
  () => import('./finances/Credit/Timetables/Timetables')
);
const FXRates = lazy(() => import('./finances/ExchangeRates'));
...
const InvestmentsDeposits = lazy(
  () => import('./finances/Investments/Deposits')
);
...
const TermsAndConditions = lazy(
  () => import('./user-pages/TermsAndConditions')
);
  ...
  return (
    <Suspense fallback={<Spinner />}>
      <Switch>
        ...
        <Route
          exact
          path='/expenses/travel/groups'
          component={ExpenseTravelGroups}
        />
        ...
        {user?.is_staff && (
          <Route exact path='/apps/messages' component={Messages} />
        )}
        {user?.is_staff && <Route exact path='/apps/todo' component={Todo} />}
        {user?.is_staff && (
          <Route exact path='/auth/groups' component={UserGroups} />
        )}
        {user?.is_staff && <Route exact path='/auth/users' component={Users} />}
        {user?.is_staff && <Route exact path='/bots' component={Bots} />}
        {user?.is_staff && (
          <Route exact path='/commands/crons' component={Crons} />
        )}
        {user?.is_staff && (
          <Route exact path='/commands/management' component={Commands} />
        )}
        {user?.is_staff && (
          <Route exact path='/commands/tasks' component={Tasks} />
        )}
        {user?.is_staff && (
          <Route exact path='/commands/watchers' component={Watchers} />
        )}
        {user?.is_staff && (
          <Route
            exact
            path='/credit/calculator'
            component={FinancesCalculator}
          />
        )}
        {user?.is_staff && (
          <Route
            exact
            path='/credit/details'
            component={FinancesCreditDetails}
          />
        )}
        {user?.is_staff && (
          <Route exact path='/credit/payments' component={FinancesPayments} />
        )}
        {user?.is_staff && (
          <Route
            exact
            path='/credit/timetables'
            component={FinancesTimetables}
          />
        )}
        {user?.is_staff && <Route exact path='/devices' component={Devices} />}
        {user?.is_staff && (
          <Route exact path='/expenses/car' component={ExpensesCar} />
        )}
        {user?.is_staff && (
          <Route
            exact
            path='/finances/accounts/transactions/:id?'
            component={FinancesAccountsTransactions}
          />
        )}
        {user?.is_staff && (
          <Route
            exact
            path='/finances/accounts/categorize'
            component={FinancesCategorize}
          />
        )}
        {user?.is_staff && <Route exact path='/fx-rates' component={FXRates} />}
        {user?.is_staff && (
          <Route exact path='/investments/bonds' component={InvestmentsBonds} />
        )}
        {user?.is_staff && (
          <Route
            exact
        ...
        {user?.is_staff && (
          <Route
            ...
            component={InvestmentsDeposits}
          />
        )}
        {user?.is_staff && (
          <Route
            exact
            path='/investments/pension'
            component={InvestmentsPension}
          />
        )}
        {user?.is_staff && (
          <Route
        ...
        {user?.is_staff && (
          <Route exact path='/events/favorites' component={FavoritesManager} />
        )}
