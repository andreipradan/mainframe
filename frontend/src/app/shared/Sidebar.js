...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      {path:'/register', state: 'userPagesMenuOpen'},
    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
            ...
            <Collapse in={ this.state.appsMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  <li className="nav-item">
                    <Link className={ this.isPathActive('/apps/expenses') ? 'nav-link active' : 'nav-link' } to="/apps/expenses">
          ...
          <li className={ this.isPathActive('/bots') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
          ...
          <li className={ this.isPathActive('/earthquakes') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
          ...
          <li className={ this.isPathActive('/login') || this.isPathActive('/register') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
