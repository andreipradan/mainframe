...
const ExchangeRates = () => {
  ...
  const uniqueFrom = [
    ...new Set(exchange.results?.map((e) => e.symbol.slice(0, 3))),
  ];
  const uniqueTo = [
    ...new Set(exchange.results?.map((e) => e.symbol.slice(3))),
  ];
  const exchangeData = {
              ...
              >
                <Form.Group>
                  ...
                  <Select
                    ...
                    options={exchange.symbols?.map((c) => ({
                      label: c.slice(0, 3),
                      value: c.slice(0, 3),
                    }))}
                    styles={selectStyles}
                ...
                <Form.Group>
                  ...
                  <Select
                    ...
                    options={[
                      ...new Set(exchange.symbols?.map((c) => c.slice(3))),
                ...
                <Form.Group>
                  ...
                  <Select
                    ...
                    options={exchange.sources?.map((c) => ({
                      label: c,
                      value: c,
                    }))}
                    styles={selectStyles}
