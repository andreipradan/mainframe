...
from bots.webhooks.butler import call
...
class TestInitialNewChatTitleAndMembers:
    ...
    @mock.patch("bots.webhooks.butler.save_to_db")
...
@pytest.mark.django_db
class TestDocuments:
    @mock.patch("bots.webhooks.butler.finance_import")
    ...
    def test_latest(self, update, logger, _):
        ...
        assert update.message.reply_text.call_args_list == [
            mock.call(
                ...
                "1</a>\n\n"
                "Depth: 1.000 km\n\n"
                "Time: 2000-01-01 08:10:10+00:00",
                **DEFAULT_REPLY_KWARGS,
            )
        ]
...
@pytest.mark.django_db
class TestInlines:
    @mock.patch("bots.webhooks.butler.BusInline")
    ...
    @mock.patch("bots.webhooks.butler.MealsInline")
    ...
    @mock.patch("bots.webhooks.butler.SavedMessagesInlines")
...
class TestMisc:
    ...
    @mock.patch("bots.webhooks.butler.get_ngrok_url")
...
class TestWhoSNext:
    ...
    @mock.patch("bots.webhooks.butler.whos_next", side_effect=CommandError("err"))
